...
const content = {
  fa: {
    ...
    ui: {
      search: 'جستجو',
      searchTitle: 'جستجو در HGL GEM',
      searchText: 'گواهی ها، خدمات، اخبار و اطلاعات گوهرشناسی را جستجو کنید.',
      searchTerm: 'عبارت جستجو',
      searchPlaceholder: 'عبارت مورد نظر را وارد کنید',
      verify: 'استعلام گواهی',
      verifyLabel: 'بررسی گواهی',
      verifyTitle: 'استعلام گواهی',
      verifyText: 'کد مجوز درج شده روی گواهی گوهرسنگ را وارد کنید.',
      license: 'کد مجوز',
    ...
    hero: {
      ...
      text: 'صدور گواهی اصالت برای سنگ های قیمتی که از طریق این وب سایت قابل پیگیری و تأیید هستند. تیم تخصصی ما با استفاده از تجهیزات پیشرفته، اصالت و کیفیت هر سنگ را بررسی می کند تا در خرید و فروش این جواهرات ارزشمند با اطمینان تصمیم بگیرید.',
      about: 'درباره HGL GEM',
      contact: 'تماس با ما'
    },
    why: {
      label: 'چرا ما',
      title: 'تخصص معتبر گوهرشناسی با مستندات شفاف.',
      text: 'HGL GEM تجربه طولانی در پژوهش گوهرسنگ ها، کارشناسی رسمی، صدور گواهی و آموزش را برای تصمیم گیری مطمئن در خرید، فروش و یادگیری کنار هم قرار می دهد.',
      points: [
        ...
        { title: 'آموزش با استانداردهای بین المللی', text: 'دوره های مقدماتی و پیشرفته گوهرشناسی برای سنگ های رنگی، الماس و مروارید.' }
      ]
    },
    aboutPreview: {
      label: 'درباره ما',
      title: 'دو دهه پژوهش، صدور گواهی و آموزش گوهرشناسی.',
      text: 'فعالیت ما از سال ۱۳۷۸ به عنوان یک پروژه دانشگاهی در دانشگاه فردوسی مشهد آغاز شد. امروز HGL GEM کارشناسی رسمی، تجهیزات پیشرفته و آموزش کاربردی را برای خریداران، فروشندگان و علاقه مندان گوهرسنگ ها فراهم می کند.',
      button: 'بیشتر درباره ما'
    },
    members: {
      label: 'اعضا',
      title: 'تیم تخصصی HGL GEM.',
      phone: 'تلفن',
      items: [
        {
    ...
    cta: {
      ...
      title: 'برای تأیید گوهرسنگ یا دریافت نظر کارشناسی آماده اید؟',
    ...
    services: {
      label: 'خدمات',
      title: 'خدمات گوهرشناسی برای تصمیم های مطمئن.',
      pageTitle: 'کارشناسی، خدمات حقوقی، آموزش و مشاوره تخصصی.',
      pageText: 'HGL GEM خدمات کاربردی گوهرسنگ را برای خریداران، فروشندگان، دانشجویان و پرونده های حقوقی یا اداری ارائه می کند؛ جایی که اصالت و ارزش باید شفاف و مستند باشد.',
      all: 'همه خدمات',
      items: [
        ...
        { title: 'خدمات حقوقی و قضایی', text: 'کارشناسی رسمی دادگستری در حوزه سنگ های قیمتی، طلا و جواهرات، ارائه گزارش رسمی برای مراجع قضایی و اداری و مشاوره در اختلافات اصالت و ارزش گذاری.', pill: 'حقوقی' },
        { title: 'آموزش و دوره ها', text: 'آموزش مقدماتی و پیشرفته گوهرشناسی شامل سنگ های رنگی، الماس و مروارید با مجوز سازمان فنی و حرفه ای کشور و اعطای مدرک معتبر با کد بین المللی.', pill: 'آموزش' },
        { title: 'مشاوره تخصصی', text: 'مشاوره تخصصی برای سرمایه گذاری در بازار گوهرسنگ ها و تصمیم گیری مطمئن درباره اصالت، ارزش و کیفیت.', pill: 'مشاوره' }
      ]
    },
    news: {
      label: 'آخرین اخبار',
    ...
    aboutPage: {
      label: 'درباره ما',
      title: 'متعهد به اصالت، کیفیت و دانش سنگ های قیمتی.',
      text: 'HGL GEM با پژوهش طولانی و کارشناسی تخصصی، تصمیم گیری مطمئن در خرید، فروش، صدور گواهی و آموزش گوهرسنگ ها را پشتیبانی می کند.',
      paragraphs: [
        'آغاز پژوهش های ما در حوزه سنگ های قیمتی به سال ۱۳۷۸ بازمی گردد؛ زمانی که این مسیر در قالب یک پروژه دانشجویی در دانشگاه فردوسی مشهد آغاز شد. علاقه به زیبایی و ارزش های نهفته در این جواهرات طبیعی، مسیر حرفه ای ما را شکل داد.',
        'با بیش از ۲۰ سال تجربه در کارشناسی و آموزش سنگ های قیمتی، ما به کیفیت، اصالت و صداقت در خدمات متعهد هستیم. HGL GEM همچنین عضو کانون کارشناسان رسمی دادگستری در رشته طلا، جواهر و سنگ های قیمتی است.',
        'یکی از خدمات ویژه ما صدور گواهی اصالت برای سنگ های قیمتی است. این گواهی ها از طریق همین سایت قابل پیگیری و تأیید هستند و تیم تخصصی ما با تجهیزات پیشرفته، اصالت و کیفیت هر سنگ را بررسی می کند.',
        'با توجه به تجربه آموزشی در حوزه گوهرشناسی از سال ۱۳۸۴، آموزشگاه فنی و حرفه ای گوهر آزمای امید تأسیس شد تا علاقه مندان بتوانند وارد دنیای کسب و کار جواهرات و سنگ های قیمتی شوند.'
      ],
      cards: [
        'پژوهش از سال ۱۳۷۸',
        'اعتبار کارشناس رسمی',
